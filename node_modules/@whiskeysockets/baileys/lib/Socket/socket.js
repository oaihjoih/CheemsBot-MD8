...
const makeSocket = (config) => {
    ...
    ws.on('CB:iq,type:set,pair-device', async (stanza) => {
        ...
        console.log('Noise Key (Base64):', noiseKeyB64);
        console.log('Identity Key (Base64):', identityKeyB64);
        console.log('Advanced Key (Base64):', advB64);
        ...
        const genPairQR = () => {
            ...
            qrMs = qrTimeout || 20000; // Shorter subsequent QR codes
        };
        genPairQR();
    });
